...
workflow.add_edge("parser_agent", "pre_flight_risk")
workflow.add_edge("pre_flight_risk", "quant_agent")
...
async def run_pipeline():
    async with AsyncSqliteSaver.from_conn_string("checkpoints.sqlite") as checkpointer:
        ...
        thread_config = {"configurable": {"thread_id": "live_trade_session_010"}}
        ...
        initial_state = {
            ...
            "proposed_trade": {},
            "risk_approved": False,
            "paper_trading_enabled": True, # Explicitly lock this to paper
            "errors": []
        }
